...
// rest of the reference system's philosophy of simulated adapters that can
// later be swapped for a real processor (e.g. Stripe) without touching the
// call sites that consume the key.
router.post("/access/purchase", async (req, res): Promise<void> => {
...
router.post("/access/classify", async (req, res): Promise<void> => {
